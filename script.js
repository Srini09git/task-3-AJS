...
//Appending elements;
container.append(heading, br1, br4, searchBox, br2, searchButton, br3);
...
async function tkrl() {
  ...
  if (input < 1 || input > 1330) {
    ...
    <img src="https://i.pinimg.com/474x/cd/ec/99/cdec99c9033c340f1c9a28cc7e9092df.jpg" class="card-img-top" alt="image">
    <div class="card-body">
